...
export function SitesFilters({ filters, onChange, showing, total }: Props) {
  ...
  return (
    <div className="sticky top-0 z-20 -mx-6 mb-6 border-b border-slate-200 bg-slate-50/95 px-6 py-4 backdrop-blur">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center">
        ...
        <p className="text-sm text-slate-600 lg:ml-auto lg:whitespace-nowrap">
          Mostrando <span className="font-medium text-slate-900">{showing}</span> de{' '}
          <span className="font-medium text-slate-900">{total}</span> sitios
        </p>
      </div>
    </div>
  );
